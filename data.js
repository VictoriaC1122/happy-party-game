const GAME_CONFIG = {
  ...
  carrierCondomLockMinimumRawSex: 2,
  carrierCondomLockBaseChance: 0.25,
  carrierCondomLockChanceStep: 0.15,
  carrierCondomLockMaxChance: 0.7,
  healthAnxietyChatThreshold: 80,
  healthAnxietyClueStep: 25,
  dissatisfactionEventThreshold: 25,
  dissatisfactionEventBaseChance: 0.08,
  dissatisfactionEventMaxChance: 0.7,
  actionOrder: [
    "oral_condom",
    "sex_condom",
    "oral_raw",
